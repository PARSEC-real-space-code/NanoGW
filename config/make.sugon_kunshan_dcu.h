...
CPPOPT  = -DUSEFFTW3 -DMPI -DDCU # -DDEBUG -DHIPMAGMA -Dmagma_devptr_t="integer*8" 
...
#MAGMADIR      = /public/home/ghfund2_a28/src/magma/git_clone_version/magma/install

#MAGMA_FLAGS = -I$(MAGMADIR)/include
HIP_FLAGS  =  -I$(HIPFORT_PATH)/include/hipfort/amdgcn
OPTS       =  -ffree-line-length-500 -Ofast -fcheck=all
OPTS2      = -I${HDF5_INC_DIR} -I$(FFTW3_INC_DIR) ${HIP_FLAGS} # ${MAGMA_FLAGS} 
...
LIBMAGMA   = # -L$(MAGMADIR)/lib -lmagma_sparse -lmagma 
